...
export function Header({ mode = "home" }: { mode?: "home" | "about" }) {
  ...
  return (
    <header className="topbar">
      ...
      <nav className="primary-nav" aria-label="Portfolio sections"><a className={mode === "home" ? "active" : ""} href="/">Overview</a><a href="/#projects">Projects</a><a className={mode === "about" ? "active" : ""} href="/about">About</a><a aria-disabled="true">Experience</a><a aria-disabled="true">Terminal</a><a aria-disabled="true">System</a><a aria-disabled="true">Logs</a></nav>
